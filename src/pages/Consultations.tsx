  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Manage medical consultations</p>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
        ...
        <p className="text-gray-600 mb-6">Consultations management features will be available soon</p>
        <button 
          onClick={() => navigate("/")}
